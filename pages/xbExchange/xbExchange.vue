...
<script>
    ...
    import{starcoinslog,personal,level} from"@/common/apis.js"
	export default {
		data() {
			return {
				gradeList:[
		...
		methods:{
            ...
            xbExchange(){
				...
				console.log(parseInt(this.value)/1000*100)
                var obj = {
                    "number":this.value,
        ...
        mounted() {
            ...
            // 获取星币
            personal({USERINFO_ID: this.USERINFO_ID}).then(res => {
                this.newNum = res.returnMsg.userInfo.STARCOINS
            })
            // 获取用户等级规则
